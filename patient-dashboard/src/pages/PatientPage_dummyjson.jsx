...
export default function PatientPage() {
  ...
  // get sensor's mock static data from DummyJSON
  useEffect(() => {
  ...
  if (!patient || !sensorData) return <div className="text-center text-gray-600 mt-20">Loading...</div>  // waiting for loading
